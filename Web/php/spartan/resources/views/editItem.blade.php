     ...
     <div id="Adicionar-editar-item" >
       <main class="mdl-layout__content">
         <div class="page-content">
           <div class="demo-card-wide mdl-card mdl-shadow--2dp collectionCard">
             <div class="mdl-card__title">
               ...
               <h2 class="mdl-card__title-text title">Editar Item</h2>
             </div>
             <form action="#">
             <div class="mdl-card__supporting-text informacoesGerais">
               ...
               <h2 class="mdl-card__title-text">Informações Principais:</h2>
                 <div class="Informacao">
                  ...
                  <div class="mdl-textfield mdl-js-textfield">
                    <input class="mdl-textfield__input" type="text" id="fname" value="{{$item->name}}">
               ...
               <div class="Informacao">
                ...
                <div class="mdl-textfield mdl-js-textfield">
                  <input class="mdl-textfield__input" type="text" id="fname" value="{{$item->author}}">
              ...
              <div class="Informacao">
               ...
               <div class="mdl-textfield mdl-js-textfield">
                 <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->year}}">
           ...
           <div class="mdl-card__supporting-text Dimensões">
             ...
             <div class="Informacao">
              ...
              <div class="mdl-textfield mdl-js-textfield">
                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->height}}">
            ...
            <div class="Informacao">
             ...
             <div class="mdl-textfield mdl-js-textfield">
               <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->width}}">
           ...
           <div class="Informacao">
            ...
            <div class="mdl-textfield mdl-js-textfield">
              <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->thickness}}">
          ...
          <div class="Informacao">
           ...
           <div class="mdl-textfield mdl-js-textfield">
             <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->lenght}}">
         ...
         <div class="Informacao">
          ...
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->innerCircumference}}">
        ...
        <div class="Informacao">
         ...
         <div class="mdl-textfield mdl-js-textfield">
           <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2" value="{{$item->outerCircumference}}">
        ...
        <div class="mdl-card__actions mdl-card--border borda"></div>
          <div class="mdl-card__supporting-text OutrasInformacoes">
            ...
            <div class="Informacao">
             ...
             <div class="mdl-textfield mdl-js-textfield">
               <input class="mdl-textfield__input" type="text" id="fname" value="{{$item->conservationState}}">
           ...
           <div class="Informacao">
            ...
            <div class="mdl-textfield mdl-js-textfield">
              <input class="mdl-textfield__input" type="text" id="fname" value="{{$item->historicalContext}}">
          ...
          <div class="Informacao">
           ...
           <div class="mdl-textfield mdl-js-textfield">
             <input class="mdl-textfield__input" type="text" id="fname" value="{{$item->biography}}">
         ...
         <div class="Informacao">
          ...
          <div class="mdl-textfield mdl-js-textfield OutrasInformacoesInput">
            <textarea class="mdl-textfield__input OutrasInformacoesInput" type="text" rows= "3" id="sample5" >{{$item->description}}</textarea>
