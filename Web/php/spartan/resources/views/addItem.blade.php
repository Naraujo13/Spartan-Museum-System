...
<div id="Adicionar-editar-item" >
     ...
     <div class="demo-card-wide mdl-card mdl-shadow--2dp collectionCard">
       ...
       <form action="/items" method="POST">
        ...
        <div class="Informacao">
         ...
         <div class="mdl-textfield mdl-js-textfield">
           <input name="itemId" class="mdl-textfield__input" type="text" id="fname">
       ...
       <div class="Informacao">
        ...
        <div class="mdl-textfield mdl-js-textfield">
          <input name="author"  class="mdl-textfield__input" type="text" id="fname">
      ...
      <div class="Informacao">
       ...
       <div class="mdl-textfield mdl-js-textfield">
         <input name="year"  class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
     ...
     <div class="Informacao">
      ...
      <div class="mdl-textfield mdl-js-textfield">
        <select class="mdl-textfield__input" id="museum" name="museu">
          ...
          <option  name="museum" value="85">{{$museum->name}}</option>
          @endforeach
        </select>
 ...
 <div class="mdl-card__supporting-text Dimensões">
   ...
   <div class="Informacao">
    ...
    <div class="mdl-textfield mdl-js-textfield">
      <input name="height" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
  ...
  <div class="Informacao">
   ...
   <div class="mdl-textfield mdl-js-textfield">
     <input name="width" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
 ...
 <div class="Informacao">
  ...
  <div class="mdl-textfield mdl-js-textfield">
    <input  name="thickness" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
...
<div class="Informacao">
 ...
 <div class="mdl-textfield mdl-js-textfield">
   <input name="lenght" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
...
<div class="Informacao">
  ...
  <div class="mdl-textfield mdl-js-textfield">
    <input  name="innerCircumference" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
...
<div class="Informacao">
 ...
 <div class="mdl-textfield mdl-js-textfield">
   <input name="outerCircumference" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample2">
...
<div class="mdl-card__supporting-text OutrasInformacoes">
  ...
  <div class="Informacao">
   ...
   <div class="mdl-textfield mdl-js-textfield">
     <input name="conservationState"  class="mdl-textfield__input" type="text" id="fname">
 ...
 <div class="Informacao">
  ...
  <div class="mdl-textfield mdl-js-textfield">
    <input name="historicalContext" class="mdl-textfield__input" type="text" id="fname">
...
<div class="Informacao">
 ...
 <div class="mdl-textfield mdl-js-textfield">
   <input name="biography" class="mdl-textfield__input" type="text" id="fname">
...
<div class="Informacao">
  ...
  <div class="mdl-textfield mdl-js-textfield OutrasInformacoesInput">
    <textarea name="description"  class="mdl-textfield__input OutrasInformacoesInput" type="text" rows= "3" id="sample5" ></textarea>
