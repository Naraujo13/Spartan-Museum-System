        ...
        AddUserButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if(ResearcherButton.isSelected()){
                    model.System.addPerson(Name.getText(), CPF.getText(), Password.getText(), Email.getText(), Integer.parseInt(UniversityRegistration.getText()));
                }
                if(TecnicianButton.isSelected()){
                    model.System.addPerson(Name.getText(), CPF.getText(), Password.getText(), Email.getText(), MuseumID.getText());
                }
                if(ResearcherButton.isSelected()){
